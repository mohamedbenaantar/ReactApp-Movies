...
export const MovieDetail = () => {
    ...
    useEffect(() => {
        async function fetchMovie(){
            const response = await fetch(`https://api.themoviedb.org/3/movie/${params.movie_id}?api_key=e40d58ef12f677b100318e00a4c4c642`)
    ...
    <main>
        <section className="flex justify-around flex-wrap py-3">
            ...
            <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
                ...
                <p className="my-2 mx-2 text-justify">{movie.overview}</p>
                {movie.genres ? (
                    <p className="my-7 flex flex-wrap grap-2">
