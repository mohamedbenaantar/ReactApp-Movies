...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div className="flex md:order-2">
    ...
    <button onClick={() => setDarkMode(!darkMode)} type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
      {(darkMode) ? (<svg
