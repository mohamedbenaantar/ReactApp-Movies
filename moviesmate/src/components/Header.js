...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <Link to="/" className="flex items-center">
      <img src={Logo} className="h-8 mr-3" alt="mywebsite Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MoviesMate</span>
  </Link>
  <div className="flex md:order-2">

    <button onClick={() => setDarkMode(!darkMode)} type="button" className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mx-2">
      {(darkMode) ? (<svg
